const SolnetexLandingPage = () => {
  ...
  function handleSubmit(event) {
    ...
    fetch('http://localhost:3001/waitlist', {
      method: 'POST',
      headers: {
  ...
  return (
    <div className="landing-page">
      ...
      <section id="features" className="features">
        <h2 className="section-title hidden">Why Choose Solnetex?</h2>
      ...
      <section id="waitlist" className="waitlist">
        <div className="waitlist-card glass-card hidden">
          ...
          <p>Be the first to experience Solnetex when we launch. Early members get exclusive benefits and discounts.</p>

          {isSubmitted ? (
            <div className="success-message">
              <div className="icon-success">✓</div>
              <h3>You're on the list!</h3>
              <p>We'll notify you when Solnetex launches.</p>
            </div>
          ) : (
      ...
      <footer className="footer">
        ...
        <div className="copyright">
          <p>&copy; 2025 Solnetex. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
...
ReactDOM.render(<SolnetexLandingPage />, document.getElementById('root'));